...
var pregenereratePropValInt32 []PropValInt32

func initPreGeneratePropValInt32() {
	pregenereratePropValInt32 = make([]PropValInt32, 128)
	for i := int32(0); i < 128; i++ {
		pregenereratePropValInt32[i] = PropValInt32{i, fmt.Sprintf("%v", i)}
	}
}
